...
def run_test_sum_of_digits():
    ...
    # -------------------------------------------------------------------------
    expected = 12
    answer = sum_of_digits(3432)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 7
    answer = sum_of_digits(52)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    expected = 18
    answer = sum_of_digits(6453)
...
def fancy_sums_of_digits(n):
    Xval=n**1000
    Xsum=sum_of_digits(Xval)
    Yval=n**999
    Ysum=sum_of_digits(Yval)
    final=sum_of_digits(Xsum**Ysum)
    return final
    """
